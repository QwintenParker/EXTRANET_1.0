...
public class Chest {
    ...
    public Chest(double x, double y, Character character, int k) {
        this.x = x;
        this.y = y;
        this.width = 20;
        this.height = 20;
            ...
            if (k == 0) {
                if (opening == 1 && st == 0) {
                    if (stuff == 0) {
                        ...
                        character.coins = character.coins + (int) ((Math.random() * 41) + 10);
                        st = 1;
                    } else if (stuff == 2) {
                ...
                if (opening == 1 && st == 0 && character.coins >= 30) {
                    character.characterHealth = character.maxHealth;
                    character.coins = character.coins - 30;
                    st = 1;
                }
            }
        }
