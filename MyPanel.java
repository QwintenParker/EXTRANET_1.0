...
public class MyPanel extends JPanel implements MouseListener {
    ...
    public MyPanel(double x, double y) throws IOException {
        ...
        this.boss = new Boss(character, 10600, 2600);
        this.world = new World(character, boss);
    ...
    public void updateWorldPhysics() {
        ...
        world.checkEnemySnypeWalls();
        world.checkAnotherEnemy();
        world.checkFireBalls();
        world.checkBossWalls();
        world.damageByBall();
        world.updateBallDamage();
        boss.createFireBalls();
        boss.updateBallDamage();
        ...
        for (int i = 0; i < character.balls.size(); i++) {
            boss.damageByBall(character.balls.get(i));
        }
        //walls0.update(dt);
